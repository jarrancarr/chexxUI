...
function menuSelect(match, item, command, update) { // console.log('menuSelect('+item+')');
    ...
    switch(item) {
        ...
        case 'lesson-starthere': lesson('Intro', command); break;
        case 'lesson-interface': lesson('Interface', command); break;
        case 'lesson-quickstart': lesson('Unimplemented', command); break;
...
function tutorials(match, command, update) { // console.log('tutorials');
    return makeMenu(match, command, update, [['........Start....... ........Here......',''],['...........Quick.......... ........Start.......',''],['.............Interface..........',''],['..........Board........',''],['.........Rules.......',''],['pawn','P'],['spear','S'],['knight','N'],['bishop','B'],['rook','R'],['queen','Q'],['archer','A'],['prince','I'],['princess','E'],['king','K'],['............Special..........',''],['.................Promotion...............',''],['.........Forks.......',''],['..............Skewers............',''],['.......Pins......',''],['...........Tactics........','']], 'lesson', -110, -104, 8);
}
function puzzles(match, command, update) { // console.log('puzzles');
    return makeMenu(match, command, update, [['...........Mate............ ...........in.................. ...........One............'],['...........Mate............ ..........in................. ...........Two...........'],['...........Mate............ ..........in................. .............Three.............'],['...........Mate............ ............in................... .............More.............']],'puzzle', -10, -6, 1);
}
...
function matchMenu(match, command, update, user) { // console.log('match');
    ...
    if (user.savedMatches) matchMenu = matchMenu.concat(makeMenu(match, command, update, user.savedMatches,'load', 175, 175+user.savedMatches.length/2, 8, 2, 1.7,'#088','#888','#ff5'));
...
function userMenu(match, command, update) {
    return makeMenu(match, command, update, [['...Conquest',''],['..Teams/. ....Tournaments.',''],['..Matches',''],['..Profile',''],['..Logout','']],'user', 99.6, 108, 8,2.7,1.6,'#8080c050');
}
